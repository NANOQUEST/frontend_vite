    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-8">
            ...
            <div className="mb-6">
                ...
                <p className="mb-2 text-gray-600">
                    When you visit NANOQUEST, we automatically collect certain
                ...
                <p className="mb-2 text-gray-600">
                    ...
                    about the individual web pages or products you view, what
                    websites or search terms referred you to the Site, and how
                ...
                <p className="text-gray-600">
                    ...
                    personal data you provide to us (including but not limited
                    to Name, Surname, Address, payment information, etc.) during
            ...
            <div className="mb-6">
                ...
                <p className="mb-2 text-gray-600">
                    ...
                    contact us via support@nanoquesttech.in.
                </p>
            </div>
            ...
            <div className="mb-6">
                ...
                <p className="mb-2 text-gray-600">
                    If you are an Indian resident, you have the following rights
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    ...
                    privacy practices. We encourage you to be aware when you
                    leave our website and read the privacy statements of each
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    ...
                    you may send an email to support@nanoquesttech.in.
                </p>
            </div>
        </div>
    );
